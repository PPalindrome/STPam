...
public class DruidDBConfig {
    ...
    // adi数据库连接信息
    @Value("${spring.datasource.druid.mainsource.url}")
    private String dbUrl;
    @Value("${spring.datasource.druid.mainsource.username}")
    private String username;
    @Value("${spring.datasource.druid.mainsource.password}")
    private String password;
    @Value("${spring.datasource.druid.mainsource.driverClassName}")
    private String driverClassName;
    // 连接池连接信息
    @Value("${spring.datasource.druid.mainsource.initialSize}")
    private int initialSize;
    @Value("${spring.datasource.druid.mainsource.minIdle}")
    private int minIdle;
    @Value("${spring.datasource.druid.mainsource.maxActive}")
    private int maxActive;
    @Value("${spring.datasource.druid.mainsource.maxWait}")
    private int maxWait;
