...
//        String file=originalFilename.substring(0,originalFilename.length()-1);
        ...
        basePath=System.getProperty("user.dir")+"/algorithm-dubboService/src/main/resources/files/uploadToWPSModel/"+fileFolder+"/";
    ...
    public void getFile(@PathVariable String flag, HttpServletResponse response){
        ...
        String basePath=System.getProperty("user.dir")+"/algorithm-dubboService/src/main/resources/files/uploadToWPSModel/"+fileFolder+"/";
