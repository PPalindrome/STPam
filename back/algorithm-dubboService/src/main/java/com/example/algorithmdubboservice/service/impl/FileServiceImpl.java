...
public class FileServiceImpl implements IFileService {
    ...
    public RespBean fileUpload(MultipartFile file) throws IOException {
        ...
        System.out.println("上传的文件名：" + fileFolder);
        String rootFilePath;
        //定义文件的唯一标识（前缀）
        //String flag = IdUtil.fastSimpleUUID();

        rootFilePath = System.getProperty("user.dir") + "/algorithm-dubboService/src/main/resources/files/algorithm/" + fileFolder + "/" + originalFilename;  //获取上传路径
    ...
    @Override
    public RespBean fileDelete(String originalFilename) {
        ...
        basePath = System.getProperty("user.dir") + "/algorithm-dubboService/src/main/resources/files/algorithm/" + fileFolder + "/";
    ...
    public void getFile(String flag, HttpServletResponse response) {
        ...
        String basePath = System.getProperty("user.dir") + "/algorithm-dubboService/src/main/resources/files/algorithm/" + fileFolder + "/";
    ...
    @Override
    public RespBean getDatasetFile(String datasetModelName, MultipartFile file) throws IOException {
        ...
        rootFilePath = System.getProperty("user.dir") + "/algorithm-dubboService/src/main/resources/files/algorithm/" + folderName + "/" + originalFilename;  //获取上传路径
        FileUtil.writeBytes(file.getBytes(), rootFilePath);   //将文件写入到上传的路径
