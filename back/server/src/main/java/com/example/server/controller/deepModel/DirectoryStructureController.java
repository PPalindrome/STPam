...
public class DirectoryStructureController {
    ...
    private final String dirPath = System.getProperty("user.dir") + "\\server\\src\\main\\resources\\files\\model\\";
    ...
    public Object getFileDirectoryStructure(@RequestBody String param) throws UnsupportedEncodingException {
        ...
        if(param.endsWith(".zip")){
            ...
            if(param.equals("SmaAt-UNet-master")){
                modelPath=dirPath+param;
            }else{
                modelPath=param;
            }
        ...
        fileList = directoryStructureService.getFileDirectoryStructure(modelPath);
